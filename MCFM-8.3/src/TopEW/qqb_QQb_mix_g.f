...
! part which is the conjugate of which we calucate
 ...
 !    .     - u1*u2))
     ...
     .     + u1 + u2)
      ...
      qqb = genfac*((ttv1+ttv2)*gvq*gvt_smeft*c(1) + (tta1+tta2)*gaq*gat_smeft*c(2))
c--- for qbq, the signs of ttv1 and ttv2 flip, tta1 and tta2 remain the same
      qbq = genfac*(-(ttv1+ttv2)*gvq*gvt_smeft*c(1) + (tta1+tta2)*gaq*gat_smeft*c(2))
...
c      print*,p
c      print*
c      print*,'REAL AMPLITUDE SQUARED:'
c      print*,'msq='
c      print*,msq
